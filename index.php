                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Terkendala</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?php echo jumlahKendala(); ?> </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Pengadaan Baru</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?php echo jumlahPengadaan(); ?> </div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Opsional</h6>
                                </div>
                                <div class="card-body">
                                    <div class="chart-bar">
                                        ...
                                        <canvas id="myBarChart" width="425" height="360" style="display: block; height: 320px; width: 378px;" class="chartjs-render-monitor"></canvas>
                                    </div>
                                    <hr>
